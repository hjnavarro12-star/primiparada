  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        <h2>🔬 Laboratorio 1</h2>
        <p>Espacio de prácticas e investigación científica.</p>
      </div>
            ...
            <ion-card class="map-card">
              ...
              <ion-card-content>
                <div class="map-placeholder">
                  ...
                  <p>El mapa te guiará al Laboratorio 1 desde tu ubicación actual.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
                ...
                <ion-list lines="none" class="info-list">
                  ...
                  <ion-item>
                    <ion-label>
                      ...
                      <!-- TODO: Química, biología, sistemas, etc. -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      ...
                      <!-- TODO: Microscopios, computadores, reactivos, etc. -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
