  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        <h2>☕ Cafetería / Restaurante</h2>
        <p>Servicios de alimentación disponibles en el campus.</p>
      </div>
            ...
            <ion-card class="map-card">
              ...
              <ion-card-content>
                <div class="map-placeholder">
                  ...
                  <p>El mapa te guiará a la cafetería desde tu ubicación actual.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
              ...
              <ion-card-content>
                <ion-list lines="none" class="info-list">
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Servicios</h3>
                      <!-- TODO: Añadir servicios (almuerzo, snacks, bebidas, etc.) -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
