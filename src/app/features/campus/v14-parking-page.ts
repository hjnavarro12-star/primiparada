  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        <h2>🅿️ Parqueadero</h2>
        <p>Zonas de estacionamiento y acceso vehicular dentro del campus.</p>
      </div>
            ...
            <ion-card class="map-card">
              ...
              <ion-card-content>
                <div class="map-placeholder">
                  ...
                  <p>El mapa te guiará al parqueadero más cercano desde tu ubicación actual.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
              ...
              <ion-card-content>
                <ion-list lines="none" class="info-list">
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Capacidad</h3>
                      <!-- TODO: Añadir número de espacios -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Vehículos permitidos</h3>
                      <!-- TODO: Carros, motos, bicicletas, etc. -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
