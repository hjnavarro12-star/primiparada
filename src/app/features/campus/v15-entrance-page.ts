  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        ...
        <p>Accesos principales al campus universitario.</p>
      </div>
        ...
        <ion-row>
          ...
          <ion-col size="12" size-lg="6">
            <ion-card class="map-card">
              <ion-card-header>
                <ion-card-title>Mapa de accesos</ion-card-title>
              </ion-card-header>
              <ion-card-content>
                <div class="map-placeholder">
                  <span class="map-icon">🗺️</span>
                  <p>El mapa te mostrará las entradas y salidas del campus.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
                ...
                <ion-list lines="none" class="info-list">
                  <ion-item>
                    <ion-label>
                      ...
                      <!-- TODO: Añadir ubicación de la entrada principal -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      <h3>Entrada secundaria</h3>
                      <!-- TODO: Añadir si existe otra entrada -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      ...
                      <!-- TODO: Añadir horarios de apertura/cierre -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Vigilancia</h3>
                      <!-- TODO: Caseta de seguridad, carné requerido, etc. -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                </ion-list>
