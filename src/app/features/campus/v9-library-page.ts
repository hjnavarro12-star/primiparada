  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        <h2>📚 Biblioteca</h2>
        <p>Consulta la ubicación, horarios y servicios de la biblioteca universitaria.</p>
      </div>
            ...
            <ion-card class="map-card">
              ...
              <ion-card-content>
                <div class="map-placeholder">
                  ...
                  <p>El mapa te guiará a la biblioteca desde tu ubicación actual.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
              ...
              <ion-card-content>
                <ion-list lines="none" class="info-list">
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Ubicación</h3>
                      <!-- TODO: Añadir ubicación exacta dentro del campus -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      <h3>Horario</h3>
                      <!-- TODO: Añadir horario de atención -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      <h3>Servicios</h3>
                      <!-- TODO: Añadir servicios disponibles -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      <h3>Capacidad</h3>
                      <!-- TODO: Añadir capacidad de personas -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                </ion-list>
