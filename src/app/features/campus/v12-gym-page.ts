  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        <h2>🏋️ Gimnasio</h2>
        <p>Información del gimnasio universitario y sus servicios.</p>
      </div>
            ...
            <ion-card class="map-card">
              ...
              <ion-card-content>
                <div class="map-placeholder">
                  ...
                  <p>El mapa te guiará al gimnasio desde tu ubicación actual.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
              ...
              <ion-card-content>
                <ion-list lines="none" class="info-list">
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Servicios</h3>
                      <!-- TODO: Añadir servicios (máquinas, canchas, etc.) -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      <h3>Requisitos</h3>
                      <!-- TODO: Añadir requisitos (carnet, ropa deportiva, etc.) -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                </ion-list>
