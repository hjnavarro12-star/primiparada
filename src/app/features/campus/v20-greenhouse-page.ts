  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        <h2>🌱 Invernaderos</h2>
        <p>Zonas verdes y espacios de cultivo académico del campus.</p>
      </div>
            ...
            <ion-card class="map-card">
              ...
              <ion-card-content>
                <div class="map-placeholder">
                  ...
                  <p>El mapa te guiará a los invernaderos desde tu ubicación actual.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
            ...
            <ion-card>
              ...
              <ion-card-content>
                <ion-list lines="none" class="info-list">
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Especies cultivadas</h3>
                      <!-- TODO: Plantas, hortalizas, especies nativas, etc. -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      ...
                      <!-- TODO: Programas vinculados, proyectos de investigación -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
