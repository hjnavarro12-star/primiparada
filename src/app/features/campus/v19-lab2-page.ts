  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        <h2>🔬 Laboratorio 2</h2>
        <p>Segundo laboratorio para prácticas académicas y proyectos.</p>
      </div>
            ...
            <ion-card class="map-card">
              ...
              <ion-card-content>
                <div class="map-placeholder">
                  ...
                  <p>El mapa te guiará al Laboratorio 2 desde tu ubicación actual.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
            ...
            <ion-card>
              ...
              <ion-card-content>
                <ion-list lines="none" class="info-list">
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Tipo de laboratorio</h3>
                      <!-- TODO: Sistemas, electrónica, etc. -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      ...
                      <!-- TODO: Computadores, software, hardware, etc. -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      <h3>Horario</h3>
                      <!-- TODO: Horario de disponibilidad -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
                    <ion-label>
                      <h3>Normas de uso</h3>
                      <!-- TODO: Reglas de uso del espacio -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                </ion-list>
