  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        ...
        <p>Servicios de salud, apoyo psicológico y acompañamiento estudiantil.</p>
      </div>
            ...
            <ion-card class="map-card">
              ...
              <ion-card-content>
                <div class="map-placeholder">
                  ...
                  <p>El mapa te guiará a Bienestar Universitario desde tu ubicación actual.</p>
                </div>
              </ion-card-content>
            </ion-card>
          </ion-col>
              ...
              <ion-card-content>
                <ion-list lines="none" class="info-list">
                  ...
                  <ion-item>
                    <ion-label>
                      <h3>Servicios</h3>
                      <!-- TODO: Añadir servicios (salud, psicología, deporte, etc.) -->
                      <p>—</p>
                    </ion-label>
                  </ion-item>
                  <ion-item>
