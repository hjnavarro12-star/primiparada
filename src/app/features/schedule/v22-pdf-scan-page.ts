  ...
  template: `
    <div class="page-content">
      <div class="page-header">
        <h2>📄 Escanear PDF</h2>
        <p>Carga un PDF con tu horario. La extracción automática estará disponible en una fase futura.</p>
      </div>
      ...
      <div class="actions">
        <button type="button" class="btn-secondary" (click)="clearFile()" [disabled]="!selectedFile()">
          Limpiar
        </button>
